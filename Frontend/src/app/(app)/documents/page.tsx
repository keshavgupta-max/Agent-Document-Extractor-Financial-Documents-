...
export default function DocumentsPage() {
  ...
  const filteredDocuments = useMemo(() => {
    return documents
      ...
      .sort((a, b) => {
        if (sortBy === "id_asc") return a.document_id.localeCompare(b.document_id);
        if (sortBy === "id_desc") return b.document_id.localeCompare(a.document_id);
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <select
              ...
              className="h-9 rounded border border-border bg-surface px-2.5 text-xs text-typography-primary focus:outline-none focus:ring-1 focus:ring-primary-500 font-medium"
            >
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-center">
                        <button
                          ...
                          aria-label={`Select document ${doc.document_id}`}
                      ...
                      <td className="px-4 py-3 text-typography-primary font-medium">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="truncate max-w-[280px] sm:max-w-md">{doc.document_id}</span>
                        </div>
                      </td>
                      ...
                      {/* Actions */}
                      <td className="px-4 py-3 text-right font-sans space-x-2">
                        <Button
                          variant="ghost"
                          size="sm"
