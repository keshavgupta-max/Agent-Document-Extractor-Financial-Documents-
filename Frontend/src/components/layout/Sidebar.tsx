  ...
  return (
    <aside className="flex h-full w-64 flex-col border-r border-border bg-surface select-none">
      ...
      <div className="flex h-16 items-center px-6 border-b border-border">
        <Link
          href="/dashboard"
          className="flex items-center space-x-2.5 text-typography-primary font-semibold tracking-tight"
          onClick={onNavigate}
        >
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex items-center space-x-3 rounded-md px-3.5 py-2.5 text-sm font-medium transition-colors",
                isActive
            ...
            >
              <Icon className={cn("h-5 w-5 flex-shrink-0", isActive ? "text-primary-600" : "text-typography-muted")} />
      ...
      <div className="border-t border-border p-4 bg-slate-50/50">
        <div className="flex flex-col space-y-1.5">
          ...
          <div className="flex items-center justify-between rounded border border-border bg-surface px-3 py-2 shadow-subtle">
